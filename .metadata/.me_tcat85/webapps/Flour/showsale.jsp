...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/Flour/WebRoot/showsale.jsp">
   <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-33" data-genuitec-path="/Flour/WebRoot/showsale.jsp">查询统计报表</strong>原粮销售统计
    <center>
