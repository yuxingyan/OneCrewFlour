...
document.getElementById("selectid").value=2;
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/Flour/WebRoot/buy.jsp">
    <form action="addbuy" id="form1" name="form1" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-3" data-genuitec-path="/Flour/WebRoot/buy.jsp">
