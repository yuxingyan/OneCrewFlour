...
<html>
  <head>
    ...
    <title>My JSP 'showbuy.jsp' starting page</title>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/Flour/WebRoot/showbuy.jsp">
     <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-28" data-genuitec-path="/Flour/WebRoot/showbuy.jsp">查询统计报表</strong>原粮购置统计
    <center>
    <form   name="原粮购置统计" action="" method="post">
 
    <table border="1" width="600"  cellspacing="0" bordercolor="#8EE1F6">
   
     <tr height="20px"><td align="center" colspan="8" >原粮购置统计</td></tr> 
     ...
     <td align="center" bgcolor="#f1f1f1">客户姓名</td>
      <td align="center" bgcolor="#f1f1f1">商品名称</td>
       <td align="center" bgcolor="#f1f1f1">交易日期</td>
        <td align="center" bgcolor="#f1f1f1">收购重量</td>
         <td align="center" bgcolor="#f1f1f1">收购单价</td>
