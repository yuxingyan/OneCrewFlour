...
<html>
  <head>
    ...
    <title>My JSP 'inquireinstore.jsp' starting page</title>
...
 window.location.href= url;
 ...
 if(n2==""||n2==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/Flour/WebRoot/inquireinstore.jsp">   <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-11" data-genuitec-path="/Flour/WebRoot/inquireinstore.jsp">查询统计报表|</strong>原粮入库统计
  <center>
     <form name="form1" id="form1" action="inquireinstore" method="post">
   
     <table border="1" width="600" cellspacing="0" bordercolor="#8EE1F6">
    
    <tr height="20px"><td align="center" colspan="4" >原粮入库统计</td></tr> 
    ...
    <tr height="20px"><td align="center" colspan="4" bgcolor="#f1f1f1">截止日期：<input type="date"name="enddate"id="date2" /></td>
    </tr>
