...
<html>
  <head>
    ...
    <title>My JSP 'inquirebuy.jsp' starting page</title>
...
 window.location.href= url;
 ...
 if(n2==""||n2==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-9" data-genuitec-path="/Flour/WebRoot/inquirebuy.jsp">
   <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-9" data-genuitec-path="/Flour/WebRoot/inquirebuy.jsp">查询统计报表</strong>原粮购置统计
    <center>
    <form  name="form1" id="form1" action="inquirebuy" method="post">
    
    <table border="1" width="600" cellspacing="0" bordercolor="#8EE1F6">
   
    <tr height="20px"><td align="center" colspan="4" >原粮购置统计</td></tr> 
