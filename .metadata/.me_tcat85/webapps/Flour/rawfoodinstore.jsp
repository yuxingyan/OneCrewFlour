...
 window.location.href= url;
 ...
 if(n5==""||n5==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/Flour/WebRoot/rawfoodinstore.jsp">
   <form action="addinstore" id="form1" name="form1" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-26" data-genuitec-path="/Flour/WebRoot/rawfoodinstore.jsp">
...
<table border="1" cellspacing="0" bordercolor="#8EE1F6">
	...
	<tr>
		...
		<td colspan="3"  bgcolor="#f1f1f1"><input id="addresstext"  style="background-color:#f1f1f1" value="" type="text"/ size="55"readonly></td>
	</tr>
	<tr>
	...
	<tr>
		<td colspan="2" align="center" bgcolor="#f1f1f1">名称</td>
		<td colspan="2" align="center" bgcolor="#f1f1f1">重量</td>
	</tr>
	<tr>
		<td colspan="2" align="center" bgcolor="#f1f1f1">小麦</td>
		<td colspan="2" bgcolor="#f1f1f1"><input type="text"name="instore.weight" id="rawstore"/></td>
	</tr>
