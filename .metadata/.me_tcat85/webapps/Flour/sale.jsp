...
function sel(){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/Flour/WebRoot/sale.jsp"> <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-27" data-genuitec-path="/Flour/WebRoot/sale.jsp">原粮兑换面粉|</strong>产品销售
   ...
   <center>
    ...
    <td colspan="2" onclick="cha();"><input type="text" id="realpay" name="realpay"    style="width:163px"></td>
    </tr>
    <tr>
