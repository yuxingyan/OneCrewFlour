...
 window.location.href= url;
 ...
 if(n2==""||n2==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-13" data-genuitec-path="/Flour/WebRoot/inquirepayout.jsp">
   <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-13" data-genuitec-path="/Flour/WebRoot/inquirepayout.jsp">查询统计报表</strong>收入支出统计
    <center>
