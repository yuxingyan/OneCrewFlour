...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/Flour/WebRoot/showprocess.jsp"> <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-32" data-genuitec-path="/Flour/WebRoot/showprocess.jsp">查询统计报表</strong>面粉加工统计
   <center>
