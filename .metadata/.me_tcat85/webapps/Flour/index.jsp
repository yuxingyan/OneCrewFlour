...
<html>
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/Flour/WebRoot/index.jsp">
  
  <img src="images/login_05.gif"width="100%"height="100" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/Flour/WebRoot/index.jsp"> 
  <div id="body" >
...
var data=[{
    ...
    {t:'欠款催收管理',s:[{t:'<a href=change target="name">欠款催收管理</a>'}]},
    {t:'面粉厂库存清点',s:[{t:'<a href=checkflourstore target="name">面粉厂库存清点</a>'}]},
    {
        t:'查询凭证报表',s:[
            {t:'<a href=inquireinstore.jsp target="name">原粮入库查询</a>'},
            {t:'<a href=inquireuse.jsp target="name">原粮领用查询</a>'},
            {t:'<a href=inquireprocess.jsp target="name">面粉加工查询</a>'},
            {t:'<a href=inquireoutstore.jsp target="name">产品出库查询</a>'},
            {t:'<a href=inquirebuy.jsp target="name">原粮购置查询</a>'},
            {t:'<a href=inquiresale.jsp target="name">产品销售查询</a>'},
            
        ]
    },
    {
        t:'系统参数',s:[
            {t:'<a href="userlogin" target="name">系统用户管理</a>'},
...
var et=new Tree(data,'esunTree');
 ...
 <div id="gb"><iframe src="welcome.jsp"width="1000"height="610"name="name"></div>
