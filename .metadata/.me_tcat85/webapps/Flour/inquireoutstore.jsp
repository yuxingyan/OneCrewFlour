...
<html>
  <head>
    ...
    <title>My JSP 'inquireoutstore.jsp' starting page</title>
...
 window.location.href= url;
 ...
 if(n2==""||n2==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/Flour/WebRoot/inquireoutstore.jsp">
    <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-12" data-genuitec-path="/Flour/WebRoot/inquireoutstore.jsp">查询统计报表</strong>产品出库统计
    <center>
       <form  name="form1" id="form1" action="inquiremanagestore" method="post">
   
     <table border="1" width="600" cellspacing="0" bordercolor="#8EE1F6">
   
    <tr height="20px"><td align="center" colspan="4" >产品出库统计</td></tr> 
