...
<html>
  <head>
	...
	<script language="javascript" type="text/javascript">
		...
		opener.document.getElementById("rawstore").value=document.getElementById("w").value;
...
 
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-10" data-genuitec-path="/Flour/WebRoot/inquireclient.jsp">
  <form id="form1" name="form1"action="inquireclient" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-10" data-genuitec-path="/Flour/WebRoot/inquireclient.jsp">
