...
<html>
  <head>
    ...
    <title>My JSP 'inquiresale.jsp' starting page</title>
...
 window.location.href= url;
 ...
 if(n2==""||n2==null){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-15" data-genuitec-path="/Flour/WebRoot/inquiresale.jsp">
  <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-15" data-genuitec-path="/Flour/WebRoot/inquiresale.jsp">查询统计报表</strong>产品销售统
    <center>
     <form  name="form1" id="form1" action="inquiresale" method="post">
    
     <table border="1" width="600" cellspacing="0" bordercolor="#8EE1F6">
  
    <tr height="20px"><td align="center" colspan="4" >产品销售统计</td></tr> 
