...
<html>
 ...
 <script type="text/javascript">
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/Flour/WebRoot/adduser.jsp"> <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-2" data-genuitec-path="/Flour/WebRoot/adduser.jsp">系统参数|</strong>用户管理
  <center>
