...
 window.location.href= url;
 ...
 if(n5==""||n5==null){
  ...
  alert("保存成功！");
    ...
    url = "otherinquireclient.jsp";//弹出窗口的页面内容
...
function sel(){
  ...
  <body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Flour/WebRoot/managestore.jsp">
  <strong style="font-size:25px" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-19" data-genuitec-path="/Flour/WebRoot/managestore.jsp">原粮兑换面粉|</strong>库存处理
    ...
    <td  bgcolor="#f1f1f1">库存重量</td>
    <td  bgcolor="#f1f1f1">处理办法</td>
    <td  bgcolor="#f1f1f1">处理重量</td>
    <td  bgcolor="#f1f1f1">单价</td>
    <td  bgcolor="#f1f1f1">总价￥</td>
    </tr>
    
    <tr>
  
    <td bgcolor="#f1f1f1"><select id="seletype"  onchange="sel();">
	<option>名称</option>
	<s:iterator value="#session.list" var="l" >
	<option name="flourtype"value="<s:property value='#l.millweight'/>"><s:property  value="#l.type"/></option>
	
	</s:iterator>
	</select>
	</td>
     <td><input id="weight" style="width:90px" type="text" readonly /></td>
     <td  bgcolor="#f1f1f1"> <select id="sele"><option> 出库</option><option> 入库</option></select></td>
     <td  bgcolor="#f1f1f1"> <input  style="width:90px" id="manageweight" type="text" name="managestore.weight" /></td>
     <td  bgcolor="#f1f1f1"> <input  style="width:90px" id="price" type="text" name="managestore.price"/></td>
     <td onclick="cal();"><input style="width:155px;background-color:#f1f1f1" id="sum" type="text" name="managestore.sum" readonly/></td>
    </tr>
    
    
    <tr><td colspan="6" >交易信息</td></tr>
    
    <tr>
    <td colspan="2" align="right" bgcolor="#f1f1f1">应收金额￥：</td>
    <td colspan="1"><input type="text" id="pay" name="pay" style="background-color:#f1f1f1" readonly/></td>
    <td colspan="2" align="right" bgcolor="#f1f1f1">实收金额￥：</td>
    <td colspan="1" onclick="cha();"><input type="text"id="realpay" style="width:155px" name="realpay" /></td>
    </tr>
    
    <tr>
    <td colspan="2" align="right" bgcolor="#f1f1f1">收付状态：</td>
    <td colspan="1"><select id="selectid">
    ...
    <td colspan="1"><input type="text" id="cha"  style="width:155px;background-color:#f1f1f1" value="0" readonly /></td>
    </tr>
    
    <tr>
           <td  colspan="3" align="right"><input type="button" onclick="Check();"value="保存"/></td>
