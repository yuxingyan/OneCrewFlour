...
  } 
 ...
 <tr>
				<td colspan="6" bgcolor="#FFFFFF">
					<label>
						<input type="radio" name="flag" value="1" onClick="change(1)">全部选择
						<input type="radio" name="flag" value="0" checked="checked" onClick="change(0)">全部取消
					</label>
				</td>
			</tr>
  <tr>
 ...
 <s:iterator value="#session.list" var="l">
			<tr>
				...
				<td><input type="hidden" id="uid"name="modify"><input type="button" id="del"value="修改" onclick="action1();"></a></input>
				</td>
			</tr>
			
			</s:iterator> <tr>
				<td align="center" colspan="6"><s:if
						test="#request.page.hasPrePage">
						<span id="spanFirst"> 
						<a href="UserAction!userlogin.action?currentPage=1">首页</a> </span>
						<span id="spanPre"><a
							href="UserAction!userlogin.action?currentPage=${page.currentPage-1}">上一页</a>
						</span>
					</s:if> <s:if test="#request.page.hasNextPage">
						<span id="spanNext"><a
							href="UserAction!userlogin.action?currentPage=${page.currentPage+1}">下一页</a>
						</span>
					</s:if>&nbsp;第 <span id="spanPageNum"></span><s:property value="#request.page.currentPage" />页/共<span id="spanTotalPage">&nbsp;<s:property value="#request.page.totalPage" /></span>页
				</td>					
			</tr>
